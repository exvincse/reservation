    ...
    <div>
        <div class="calendar">
            ...
            <div class="d-flex justify-content-between text-center">
                <div class="datewidth" v-for="(i,index) in 7" :key="i" :class="{'text-danger':index===0 || index===6}">{{week(index)}}</div>
            </div>
            <div class="d-flex flex-wrap justify-content-between text-center">
                ...
                <div class="datewidth" v-for="day in nowmonthdate" :key="day" :class="{'out':noclick(day)}">
                    <span v-if="dayoverflow(day-1)" :class="{'text-danger':holiday(day)}">{{day}}</span>
